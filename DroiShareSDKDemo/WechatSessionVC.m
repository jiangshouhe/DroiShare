...
@interface WechatSessionVC ()
@property (weak, nonatomic) IBOutlet UITableView *listTableView;
@property(nonatomic,strong)NSMutableArray *dataSourceArray;
@end

@implementation WechatSessionVC
...
- (NSMutableArray *)dataSourceArray
{
    if (_dataSourceArray == nil) {
        ...
        [_dataSourceArray addObject:@"分享文本给微信好友"];
        
        [_dataSourceArray addObject:@"分享（本地图片）给微信好友"];
        [_dataSourceArray addObject:@"分享（网络图片）给微信好友"];
        
        [_dataSourceArray addObject:@"分享网页链接(缩略图为本地图片)给微信好友"];
        [_dataSourceArray addObject:@"分享网页链接(缩略图为网络图片)给微信好友"];
        
        [_dataSourceArray addObject:@"分享网络视频(缩略图为本地图片)给微信好友"];
        [_dataSourceArray addObject:@"分享网络视频(缩略图为网络图片)给微信好友"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.row) {
        ...
        case 1:
        {
            ...
            UIImage *localImage = [UIImage imageWithData:localData];//缩略图
